...
const guideStrings = {
  en: {
    ...
    heroTitle: "689 things still made here. And counting.",
    ...
    verifiedEntries: "VERIFIED ENTRIES, AND COUNTING",
    checkedDate: "CHECKED 30.08.26",
    ...
    supportBodyTwo: "Optional contributions help cover hosting, source verification, translation, regular updates, and the development of free printable and physical field resources. That includes the research tools used to verify each new listing before it goes live. When funding permits, printed materials will be distributed to communities at no charge.",
    ...
    metaDescription: "Search 689+ source-verified products made in Canada across tariff-affected sectors, and counting.",
    ...
    productSubmitIntro: "Suggest a Canadian-made product for independent research. Every accepted entry is fully vetted before it appears in the catalogue \u2014 now at 689 entries and counting.",
  ...
  fr: {
    ...
    heroTitle: "689 produits encore fabriqués ici. Et ce n’est pas fini.",
    ...
    verifiedEntries: "ENTRÉES VÉRIFIÉES, ET LE NOMBRE AUGMENTE",
    checkedDate: "VÉRIFIÉ LE 30.08.26",
    ...
    supportBodyTwo: "Les contributions facultatives aident à payer l’hébergement, la vérification des sources, la traduction, les mises à jour régulières et la création de ressources imprimables et physiques gratuites. Cela comprend les outils de recherche utilisés pour vérifier chaque nouvelle fiche avant sa publication. Lorsque le financement le permettra, du matériel imprimé sera distribué gratuitement dans les communautés.",
    ...
    footerPrivacy: "Déclaration de confidentialité",
    ...
    metaDescription: "Recherchez plus de 689 produits fabriqués au Canada et vérifiés à la source dans les secteurs touchés par les tarifs, et ce n’est pas fini.",
    ...
    productSubmitIntro: "Suggérez un produit fabriqué au Canada pour une recherche indépendante. Chaque fiche acceptée est entièrement vérifiée avant de paraître dans le catalogue — déjà à 689 produits, et ce n’est pas fini.",
