...
const guideStrings = {
  en: {
    ...
    heroTitle: "688 things still made here. And counting.",
    ...
    metaDescription: "Search 688+ source-verified products made in Canada across tariff-affected sectors, and counting.",
    ...
    productSubmitIntro: "Suggest a Canadian-made product for independent research. Every accepted entry is fully vetted before it appears in the catalogue \u2014 now at 688 entries and counting.",
  ...
  fr: {
    ...
    heroTitle: "688 produits encore fabriqués ici. Et ce n’est pas fini.",
    ...
    metaDescription: "Recherchez plus de 688 produits fabriqués au Canada et vérifiés à la source dans les secteurs touchés par les tarifs, et ce n’est pas fini.",
    ...
    productSubmitIntro: "Suggérez un produit fabriqué au Canada pour une recherche indépendante. Chaque fiche acceptée est entièrement vérifiée avant de paraître dans le catalogue — déjà à 688 produits, et ce n’est pas fini.",
